...
public class InitialInstanceWrapper {
    ...
    public static InitialInstanceWrapper build() {
        ...
        return new InitialInstanceWrapper();
    }

    public InitialInstanceVo entityVO(InitialInstance initialInstance) {
        if (initialInstance == null)
            return null;
        InitialInstanceVo initialInstanceVo = new InitialInstanceVo();
        BeanUtils.copyProperties(initialInstance, initialInstanceVo);
        ArrayList<InitialInstanceVo> collect = new ArrayList<InitialInstanceVo>();
        collect.add(initialInstanceVo);
        
		translateDict(collect);
        return initialInstanceVo;
    }

    public List<InitialInstanceVo> entityVOList(List<InitialInstance> list) {
        List<InitialInstanceVo> collect = list.stream().map(entity -> {
            InitialInstanceVo initialInstanceVo = new InitialInstanceVo();
            BeanUtils.copyProperties(entity, initialInstanceVo);
            return initialInstanceVo;
	...
	public List<InitialInstanceVo> translateDict(List<InitialInstanceVo> list){
    ...
    public IPage<InitialInstanceVo> pageVO(IPage<InitialInstance> source) {
        Page<InitialInstanceVo> page = new Page<InitialInstanceVo>();
  	...
  	public void validateInitialInstance(InitialInstance initialInstance){
      
    }

    public void initInitialInstance(InitialInstance initialInstance){
