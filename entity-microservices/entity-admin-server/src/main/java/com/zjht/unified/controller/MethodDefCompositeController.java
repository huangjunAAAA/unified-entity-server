 ...
 * @author wangy
 */
@Api(value = "整图结构关系(methodDef)维护",tags = {"整图结构关系(methodDef)维护"})
@RestController
...
public class MethodDefCompositeController extends BaseController{
    ...
    /**
     * 查询整图结构关系(methodDef)列表, 对象形式
     */
    @ApiOperation(value = "查询整图结构关系(methodDef)列表")
    ...
    /**
     * 获取整图结构关系(methodDef)Composite详细信息
     */
    @ApiOperation(value = "获取整图结构关系(methodDef)Composite详细信息")
    @GetMapping(value = "/{id}")
     ...
     * 新增整图结构关系(methodDef)
     */
    @ApiOperation(value = "新增整图结构关系(methodDef)Composite")
    @PostMapping
     ...
     * 修改整图结构关系(methodDef)
     */
    @ApiOperation(value = "修改整图结构关系(methodDef)Composite")
    @PostMapping("/edit")
    ...
    /**
     * 删除整图结构关系(methodDef)Composite
     */
    @ApiOperation(value = "删除整图结构关系(methodDef)Composite")
