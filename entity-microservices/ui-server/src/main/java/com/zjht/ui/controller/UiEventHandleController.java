...
public class UiEventHandleController extends BaseController{
    ...
    /**
     * 获取项目与组件统一模型(uiEventHandle)详细信息
     */
    @ApiOperation(value = "获取项目与组件统一模型(uiEventHandle)详细信息")
    @GetMapping(value = "/{id}")
     ...
     */
    @ApiOperation(value = "新增项目与组件统一模型(uiEventHandle)")
    @PostMapping
     ...
     */
    @ApiOperation(value = "修改项目与组件统一模型(uiEventHandle)")
    @PostMapping("/edit")
    ...
    /**
     * 删除项目与组件统一模型(uiEventHandle)
     */
    @ApiOperation(value = "删除项目与组件统一模型(uiEventHandle)")
    ...
    public R<Integer> remove(@PathVariable Long[] ids)
    {
	 ...
	 /**
     * 项目与组件统一模型(uiEventHandle)的动态字典
     */
    @ApiOperation(value = "项目与组件统一模型(uiEventHandle)的字典接口", notes = "传入id获取唯一对应值，或传空获取所有值",hidden = true)
    @PostMapping("/dict")
